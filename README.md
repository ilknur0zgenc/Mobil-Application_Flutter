...
1.  **Gelişim Takibi:** Temel Dart yapılarından, Flutter ile karmaşık UI (Kullanıcı Arayüzü) bileşenlerine geçiş sürecinizi belgelemek.
2.  **Teknik Yetkinlik:** **Dart** dilinin temel özelliklerini (fonksiyonlar, döngüler, sınıflar) ve **Flutter** çatısının temel widget'larını kullanabildiğinizi göstermek.
3.  **Proje Yönetimi:** GitHub üzerinden kod paylaşma, sürüm kontrolü ve profesyonel bir README dosyası hazırlama yeteneğinizi sergilemek.
...
| Proje / Konu Adı | Öğrenilen Temel Kavramlar |
| :--- | :--- |
| **Temel Değişken Tanımlama** | `int`, `String`, `double`, `bool`, `dynamic` veri tipleri. **Kodlama standartları** (camelCase, snake\_case, PascalCase). |
